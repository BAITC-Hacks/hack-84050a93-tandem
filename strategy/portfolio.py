...
def shadow_portfolio(options, budget, contacts):
...
def choose_portfolio(options, budget, contacts):
    incumbent = shadow_portfolio(options, budget, contacts)
    improved = allocate_channels(incumbent, options, budget)
    return sorted(improved, key=lambda o: (-o.gain, o.campaign['filter_current_tariff'], o.campaign['channel']))
