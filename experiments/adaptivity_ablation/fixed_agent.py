# Generated by build_candidate.py from pinned main Agent; see protocol.md.
...
class FixedSurveyAgent:
    ...
    def act(self, env):
        ...
        # Keep pristine real beliefs separate from the fantasy planning ledger.
        real_env = env
        ...
        # The complete schedule exists before the first real run_pilot call.
