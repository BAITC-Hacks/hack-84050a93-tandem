...
Нужен **полный репозиторий и Python 3.12**. Проверенное окружение: CPython
3.12.13, NumPy 2.5.3, pandas 3.0.6. Команды выполняются из корня репозитория.
...
позднее добавлены проверка финала, журналирование и инструменты отчёта.
